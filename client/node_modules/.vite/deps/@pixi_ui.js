import {
  NineSliceSprite,
  Text
} from "./chunk-V7YX74L6.js";
import "./chunk-GGD23QBK.js";
import {
  isMobile
} from "./chunk-HVFDHKCI.js";
import "./chunk-ZG627KAV.js";
import "./chunk-GXMWBSIT.js";
import "./chunk-B6POJYIA.js";
import "./chunk-3ASH4OMC.js";
import "./chunk-VVAD5AU4.js";
import "./chunk-PJHJL7PZ.js";
import {
  Graphics
} from "./chunk-JUFYBMOB.js";
import "./chunk-G5L7ARGX.js";
import "./chunk-Z7SWGD4J.js";
import "./chunk-E2DRKN7Z.js";
import "./chunk-MF64FGOD.js";
import "./chunk-A6FP6TEG.js";
import {
  Container,
  ObservablePoint,
  Sprite,
...
var ButtonEvents = class {
  constructor() {
    __publicField(this, "_isMouseIn", false);
    __publicField(this, "_isDown", false);
...
var Button = class extends ButtonEvents {
  ...
  get enabled() {
    var _a;
    return ((_a = this.view) == null ? void 0 : _a.eventMode) === "static";
  }
};
...
// node_modules/@pixi/ui/lib/Dialog.mjs
...
var FancyButton = class extends ButtonContainer {
  ...
  constructor(options) {
    super();
    __publicField6(this, "animations");
    __publicField6(this, "originalInnerViewState");
    __publicField6(this, "defaultDuration", 100);
    __publicField6(this, "options");
    __publicField6(this, "_padding", 0);
    __publicField6(this, "_offset", {});
    __publicField6(this, "_textOffset", {});
    __publicField6(this, "iconOffset", {});
    __publicField6(this, "innerView", new Container());
    __publicField6(this, "_views", {});
    __publicField6(this, "state", "default");
    __publicField6(this, "anchor");
    __publicField6(this, "_defaultTextScale", { x: 1, y: 1 });
    __publicField6(this, "_defaultIconScale", { x: 1, y: 1 });
    __publicField6(this, "_defaultTextAnchor", { x: 0.5, y: 0.5 });
    __publicField6(this, "_defaultIconAnchor", { x: 0.5, y: 0.5 });
    this.options = options ?? {};
    const {
      defaultView,
      hoverView,
  ...
  setOriginalInnerViewState() {
    ...
    if (defaultStateAnimation) {
      ...
      this.innerView.scale.x = ((_b = defaultStateAnimation.props.scale) == null ? void 0 : _b.x) ?? ((_c = this.originalInnerViewState.scale) == null ? void 0 : _c.x) ?? 1;
      this.innerView.scale.y = ((_d = defaultStateAnimation.props.scale) == null ? void 0 : _d.y) ?? ((_e = this.originalInnerViewState.scale) == null ? void 0 : _e.y) ?? 1;
    }
  }
  initStateControl() {
    this.onDown.connect(() => {
...
var List = class extends Container {
  constructor(options) {
    ...
    __publicField7(this, "_type", "bidirectional");
    __publicField7(this, "_maxWidth", 0);
    __publicField7(this, "children", []);
    if (options) {
      if (options.maxWidth) {
...
var Spring = class {
  constructor(options = {}) {
    __publicField8(this, "x");
    __publicField8(this, "ax");
    __publicField8(this, "dx");
    __publicField8(this, "tx");
    __publicField8(this, "_options");
    this.x = 0;
    this.ax = 0;
    this.dx = 0;
    this.tx = 0;
...
var ScrollSpring = class {
  constructor() {
    __publicField9(this, "done", false);
    __publicField9(this, "to", 0);
    __publicField9(this, "_spring");
    __publicField9(this, "_pos", 0);
    __publicField9(this, "_speed", 0);
    __publicField9(this, "_correctSpeed", false);
...
var SlidingNumber = class {
  constructor(options = {}) {
    __publicField10(this, "position", 0);
    __publicField10(this, "constrain", true);
    __publicField10(this, "min", 0);
    __publicField10(this, "max", 0);
    __publicField10(this, "maxSpeed", 400);
    __publicField10(this, "_ease");
    __publicField10(this, "_offset", 0);
    __publicField10(this, "_prev", 0);
    __publicField10(this, "_speed", 0);
    __publicField10(this, "_hasStopped", false);
    __publicField10(this, "_targetSpeed", 0);
    __publicField10(this, "_speedChecker", 0);
    __publicField10(this, "_grab", 0);
    __publicField10(this, "_activeEase");
...
var Trackpad = class {
  constructor(options) {
    __publicField11(this, "xAxis");
    __publicField11(this, "yAxis");
    __publicField11(this, "_isDown", false);
    __publicField11(this, "_globalPosition");
    __publicField11(this, "_frame");
    __publicField11(this, "_bounds");
    __publicField11(this, "_dirty", false);
    __publicField11(this, "disableEasing", false);
...
var ScrollBox = class extends Container {
  ...
  constructor(options) {
    super();
    __publicField12(this, "background");
    __publicField12(this, "borderMask");
    __publicField12(this, "lastWidth", 0);
    __publicField12(this, "lastHeight", 0);
    __publicField12(this, "_width", 0);
    __publicField12(this, "_height", 0);
    __publicField12(this, "_dimensionChanged", false);
    __publicField12(this, "list");
    __publicField12(this, "_trackpad");
    __publicField12(this, "isDragging", 0);
    __publicField12(this, "interactiveStorage", []);
    __publicField12(this, "visibleItems", []);
    __publicField12(this, "pressedChild");
    __publicField12(this, "ticker", Ticker.shared);
    __publicField12(this, "options", {});
    __publicField12(this, "stopRenderHiddenItemsTimeout");
    __publicField12(this, "onMouseScrollBinding", this.onMouseScroll.bind(this));
    __publicField12(this, "dragStarTouchPoint");
    __publicField12(this, "isOver", false);
    __publicField12(this, "proximityRange", 0);
    __publicField12(this, "proximityStatusCache", []);
    __publicField12(this, "lastScrollX");
    __publicField12(this, "lastScrollY");
    __publicField12(this, "proximityCheckFrameCounter", 0);
    __publicField12(this, "onProximityChange", new import_typed_signals4.Signal());
    __publicField12(this, "onScroll", new import_typed_signals4.Signal());
    if (options) {
      this.init(options);
    }
  ...
  init(options) {
    ...
    this._width = options.width ?? ((_a = this.background) == null ? void 0 : _a.width) ?? 100;
    this._height = options.height ?? ((_b = this.background) == null ? void 0 : _b.height) ?? 100;
    this.proximityRange = options.proximityRange ?? 0;
    if (!this.list) {
      this.list = new List();
      super.addChild(this.list);
    }
    (_c = this.list) == null ? void 0 : _c.init({
      type: options.type,
  ...
  removeItems() {
    ...
    (_a = this.list) == null ? void 0 : _a.removeChildren();
  }
  /**
  ...
  addItem(...items) {
    ...
    if (items.length > 1) {
      ...
      (_a = this.list) == null ? void 0 : _a.addChild(child);
  ...
  removeItem(itemID) {
    var _a;
    (_a = this.list) == null ? void 0 : _a.removeItem(itemID);
  ...
  makeScrollable() {
    ...
    this.on("pointerdown", (e) => {
      ...
      const listTouchPoint = (_a = this.list) == null ? void 0 : _a.worldTransform.applyInverse(e.global);
      if (listTouchPoint) {
    ...
    this.on("pointerup", () => {
      var _a;
      this.isDragging = 0;
      (_a = this._trackpad) == null ? void 0 : _a.pointerUp();
    ...
    this.on("globalpointermove", (e) => {
      ...
      (_a = this._trackpad) == null ? void 0 : _a.pointerMove(new Point(touchPoint.x, touchPoint.y));
      if (this.pressedChild) {
        this.revertClick(this.pressedChild);
        this.pressedChild = void 0;
      }
      if (this.isBidirectional) {
        (_b = this.onScroll) == null ? void 0 : _b.emit({ x: this.scrollX, y: this.scrollY });
      } else {
        (_c = this.onScroll) == null ? void 0 : _c.emit(this.isVertical ? this.scrollY : this.scrollX);
      }
    });
  ...
  get listHeight() {
    var _a, _b, _c;
    return (((_a = this.list) == null ? void 0 : _a.height) ?? 0) + (((_b = this.list) == null ? void 0 : _b.topPadding) ?? 0) + (((_c = this.list) == null ? void 0 : _c.bottomPadding) ?? 0);
  }
  get listWidth() {
    var _a, _b, _c;
    return (((_a = this.list) == null ? void 0 : _a.width) ?? 0) + (((_b = this.list) == null ? void 0 : _b.leftPadding) ?? 0) + (((_c = this.list) == null ? void 0 : _c.rightPadding) ?? 0);
  }
  /**
  ...
  resize(force = false) {
    ...
    if (this.borderMask && (force || this._dimensionChanged || this.lastWidth !== this.listWidth || this.lastHeight !== this.listHeight)) {
      ...
      (_a = this.borderMask) == null ? void 0 : _a.clear().roundRect(0, 0, this._width, this._height, (this.options.radius ?? 0) | 0).fill(16711935).stroke(0);
      if (this.borderMask) this.borderMask.eventMode = "none";
      const color = this.options.background;
      (_b = this.background) == null ? void 0 : _b.clear().roundRect(0, 0, this._width, this._height, (this.options.radius ?? 0) | 0).fill({
        color: color ?? 0,
        alpha: color ? 1 : 1e-7
    ...
    if (this._trackpad && this.borderMask) {
      const maxWidth = this.borderMask.width - (((_c = this.list) == null ? void 0 : _c.width) ?? 0) - (((_d = this.list) == null ? void 0 : _d.leftPadding) ?? 0) - (((_e = this.list) == null ? void 0 : _e.rightPadding) ?? 0);
      const maxHeight = this.borderMask.height - (((_f = this.list) == null ? void 0 : _f.height) ?? 0) - (((_g = this.list) == null ? void 0 : _g.topPadding) ?? 0) - (((_h = this.list) == null ? void 0 : _h.bottomPadding) ?? 0);
      if (this.isBidirectional) {
    ...
    if (this._dimensionChanged) {
      (_i = this.list) == null ? void 0 : _i.arrangeChildren();
      this.stopRenderHiddenItems();
      this._dimensionChanged = false;
    } else {
      if (force) (_j = this.list) == null ? void 0 : _j.arrangeChildren();
  ...
  onMouseScroll(event) {
    ...
    if ((this.isHorizontal || this.isBidirectional) && scrollOnX) {
      ...
      const targetPos = (((_a = this.list) == null ? void 0 : _a.x) ?? 0) - delta;
    ...
    if ((this.isVertical || this.isBidirectional) && scrollOnY) {
      const targetPos = (((_b = this.list) == null ? void 0 : _b.y) ?? 0) - event.deltaY;
    ...
    if (this.isBidirectional && (scrollOnX || scrollOnY)) {
      (_e = this.onScroll) == null ? void 0 : _e.emit({ x: ((_c = this._trackpad) == null ? void 0 : _c.xAxis.value) ?? 0, y: ((_d = this._trackpad) == null ? void 0 : _d.yAxis.value) ?? 0 });
    } else if (this.isHorizontal && scrollOnX) {
      (_g = this.onScroll) == null ? void 0 : _g.emit(((_f = this._trackpad) == null ? void 0 : _f.xAxis.value) ?? 0);
    } else if (this.isVertical && scrollOnY) {
      (_i = this.onScroll) == null ? void 0 : _i.emit(((_h = this._trackpad) == null ? void 0 : _h.yAxis.value) ?? 0);
    }
    this.stopRenderHiddenItems();
  }
  ...
  scrollBottom() {
    ...
    if (!this.interactive) {
      ...
      this.scrollTo((((_a = this.list) == null ? void 0 : _a.children.length) ?? 1) - 1);
    }
  }
  ...
  get scrollX() {
    var _a;
    return ((_a = this._trackpad) == null ? void 0 : _a.xAxis.value) ?? 0;
  }
  ...
  get scrollY() {
    var _a;
    return ((_a = this._trackpad) == null ? void 0 : _a.yAxis.value) ?? 0;
  }
  ...
  destroy(options) {
    ...
    (_a = this.background) == null ? void 0 : _a.destroy();
    (_b = this.list) == null ? void 0 : _b.destroy();
  ...
  get scrollHeight() {
    var _a;
    return ((_a = this.list) == null ? void 0 : _a.height) ?? 0;
  }
  get scrollWidth() {
    var _a;
    return ((_a = this.list) == null ? void 0 : _a.width) ?? 0;
  }
  get isVertical() {
...
var Dialog = class extends Container {
  /**
  ...
  constructor(options) {
    var _a, _b;
    super();
    __publicField13(this, "backdrop");
    __publicField13(this, "innerView");
    __publicField13(this, "contentView");
    __publicField13(this, "titleText");
    __publicField13(this, "contentBody");
    __publicField13(this, "scrollBox");
    __publicField13(this, "buttonContainer");
    __publicField13(this, "options");
    __publicField13(this, "_isOpen", false);
    __publicField13(this, "onSelect");
    __publicField13(this, "onClose");
    this.options = options;
    this.onSelect = new import_typed_signals5.Signal();
    this.onClose = new import_typed_signals5.Signal();
    ...
    if (height) {
      ...
      if ((_a = this.titleText) == null ? void 0 : _a.height) {
    ...
    (_b = this.innerView) == null ? void 0 : _b.addChild(this.scrollBox);
    this.visible = false;
    this.initContent();
    Ticker.shared.add(() => Group.shared.update());
  }
  ...
  get dialogWidth() {
    var _a;
    return this.options.width ?? ((_a = this.innerView) == null ? void 0 : _a.width) ?? 0;
  }
  /** Gets the dialog height from options or innerView. */
  get dialogHeight() {
    var _a;
    return this.options.height ?? ((_a = this.innerView) == null ? void 0 : _a.height) ?? 0;
  }
  ...
  open() {
    ...
    this.visible = true;
    this._isOpen = true;
    const openAnimation = (_a = this.options.animations) == null ? void 0 : _a.open;
    if (!openAnimation) {
  ...
  close() {
    var _a;
    if (!this.innerView) return;
    const closeAnimation = (_a = this.options.animations) == null ? void 0 : _a.close;
    if (!closeAnimation) {
      this.visible = false;
      this._isOpen = false;
      this.onClose.emit();
...
var ProgressBar = class extends Container {
  ...
  constructor(options) {
    super();
    __publicField14(this, "bg");
    __publicField14(this, "fill");
    __publicField14(this, "fillMask");
    __publicField14(this, "progressStart", 0);
    __publicField14(this, "_progress", 0);
    __publicField14(this, "options");
    __publicField14(this, "innerView");
...
var SliderBase = class extends ProgressBar {
  constructor(options) {
    super(options);
    __publicField15(this, "_slider1");
    __publicField15(this, "_slider2");
    __publicField15(this, "value1Text");
    __publicField15(this, "value2Text");
    __publicField15(this, "_value1", 0);
    __publicField15(this, "_value2", 0);
    __publicField15(this, "dragging", 0);
    __publicField15(this, "_min", 0);
    __publicField15(this, "_max", 100);
    __publicField15(this, "_step", 1);
    __publicField15(this, "startX");
    __publicField15(this, "startUpdateValue1");
    __publicField15(this, "startUpdateValue2");
    __publicField15(this, "settings");
...
var DoubleSlider = class extends SliderBase {
  constructor(options) {
    super(options);
    __publicField16(this, "sliderOptions");
    __publicField16(this, "activeValue");
    __publicField16(this, "onChange", new import_typed_signals6.Signal());
    __publicField16(this, "onUpdate", new import_typed_signals6.Signal());
  ...
  updateSlider1() {
    ...
    this.updateProgress(this.value1, this.value2);
    this._slider1.x = (((_a = this.bg) == null ? void 0 : _a.width) ?? 0) / 100 * this.progressStart - this._slider1.width / 2;
    this._slider1.y = (((_b = this.bg) == null ? void 0 : _b.height) ?? 0) / 2;
    if (this._slider2 && this._slider1.x > this._slider2.x) {
      this._slider1.x = this._slider2.x;
    }
    if (((_c = this.sliderOptions) == null ? void 0 : _c.showValue) && this.value1Text && this._slider1) {
  ...
  updateSlider2() {
    ...
    this.updateProgress(this.value1, this.value2);
    this._slider2.x = (((_a = this.bg) == null ? void 0 : _a.width) ?? 0) / 100 * this.progress - this._slider2.width / 2;
    this._slider2.y = (((_b = this.bg) == null ? void 0 : _b.height) ?? 0) / 2;
    if (this._slider1 && this._slider2.x < this._slider1.x) {
      this._slider2.x = this._slider1.x;
    }
    if (((_c = this.sliderOptions) == null ? void 0 : _c.showValue) && this.value2Text && this._slider2) {
...
var Input = class extends Container {
  ...
  constructor(options) {
    super();
    __publicField17(this, "_bg");
    __publicField17(this, "inputMask");
    __publicField17(this, "_cursor");
    __publicField17(this, "_value", "");
    __publicField17(this, "_secure", false);
    __publicField17(this, "inputField");
    __publicField17(this, "placeholder");
    __publicField17(this, "editing", false);
    __publicField17(this, "tick", 0);
    __publicField17(this, "lastInputData", "");
    __publicField17(this, "activation", false);
    __publicField17(this, "options");
    __publicField17(this, "input");
    __publicField17(this, "handleActivationBinding", this.handleActivation.bind(this));
    __publicField17(this, "onKeyUpBinding", this.onKeyUp.bind(this));
    __publicField17(this, "stopEditingBinding", this.stopEditing.bind(this));
    __publicField17(this, "onInputBinding", this.onInput.bind(this));
    __publicField17(this, "onPasteBinding", this.onPaste.bind(this));
    __publicField17(this, "onEnter");
    __publicField17(this, "onChange");
    __publicField17(this, "paddingTop", 0);
    __publicField17(this, "paddingRight", 0);
    __publicField17(this, "paddingBottom", 0);
    __publicField17(this, "paddingLeft", 0);
    const defaultOptions = {
      bg: Texture.WHITE,
      textStyle: {
        fill: 0,
    ...
    this.onEnter = new import_typed_signals7.Signal();
    this.onChange = new import_typed_signals7.Signal();
  ...
  createInputField() {
    ...
    input.style.width = `${((_c = this._bg) == null ? void 0 : _c.width) ?? 100}px`;
    input.style.height = `${((_d = this._bg) == null ? void 0 : _d.height) ?? 30}px`;
...
var MaskedFrame = class extends Container {
  constructor(options) {
    super();
    __publicField18(this, "target");
    __publicField18(this, "border", new Graphics());
    __publicField18(this, "_targetMask");
    __publicField18(this, "maskData");
    __publicField18(this, "borderWidth", 0);
    __publicField18(this, "borderColor", 0);
...
var RadioGroup = class extends Container {
  constructor(options) {
    super();
    __publicField19(this, "items", []);
    __publicField19(this, "innerView");
    __publicField19(this, "value", "");
    __publicField19(this, "selected", 0);
    __publicField19(this, "onChange");
    __publicField19(this, "options");
    const defaultOptions = {
      items: [],
      type: "vertical",
      elementsMargin: 0,
    ...
    this.options = { ...defaultOptions, ...options };
    this.onChange = new import_typed_signals8.Signal();
    this.init(this.options);
  }
  /**
   * Initiates a group.
  ...
  init(options) {
    ...
    this.value = ((_b = (_a = options.items[this.selected]) == null ? void 0 : _a.labelText) == null ? void 0 : _b.text) ?? "";
    if (this.innerView) {
  ...
  addItems(items) {
    items.forEach((checkBox, id) => {
      ...
      (_a = this.innerView) == null ? void 0 : _a.addChild(checkBox);
    });
  }
  /**
  ...
  removeItems(ids) {
    ids.forEach((id) => {
      ...
      (_a = this.innerView) == null ? void 0 : _a.removeChild(item);
...
var Select = class extends Container {
  constructor(options) {
    super();
    __publicField20(this, "view", new Container());
    __publicField20(this, "openButton");
    __publicField20(this, "closeButton");
    __publicField20(this, "openView");
    __publicField20(this, "scrollBox");
    __publicField20(this, "value", -1);
    __publicField20(this, "onSelect");
    this.addChild(this.view);
    this.onSelect = new import_typed_signals9.Signal();
    if (options) {
      this.init(options);
    }
  }
  ...
  addItems(items, selected = 0) {
    this.convertItemsToButtons(items).forEach((button, id) => {
      ...
      (_a = this.scrollBox) == null ? void 0 : _a.addItem(button);
    });
  }
  /**
...
var import_typed_signals10 = __toESM(require_dist(), 1);
...
var __publicField21 = (obj, key, value) => __defNormalProp21(obj, typeof key !== "symbol" ? key + "" : key, value);
var Slider = class extends SliderBase {
  constructor(options) {
    ...
    __publicField21(this, "sliderOptions");
    __publicField21(this, "onUpdate", new import_typed_signals10.Signal());
    __publicField21(this, "onChange", new import_typed_signals10.Signal());
    this.sliderOptions = options;
  ...
  updateSlider() {
    ...
    this._slider1.x = (((_a = this.bg) == null ? void 0 : _a.width) ?? 0) / 100 * this.progress - this._slider1.width / 2;
    this._slider1.y = (((_b = this.bg) == null ? void 0 : _b.height) ?? 0) / 2;
    if (((_c = this.sliderOptions) == null ? void 0 : _c.showValue) && this.value1Text) {
